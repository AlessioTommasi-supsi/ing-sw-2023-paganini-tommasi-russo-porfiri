        ...
        switch(getIndex()) {
            case 7 -> {
                for(int i = 0; i < 6; i++) {
                    ...
                    if (player.getShelves().getTilePosition(0, i).getTile() != null) {
                        tileTypes.add(player.getShelves().getTilePosition(0, i).getTile().getType());
                        if (player.getShelves().getTilePosition(1, i).getTile() != null) {
                            if (tileTypes.contains(player.getShelves().getTilePosition(1, i).getTile().getType())) {
                                ...
                                if (player.getShelves().getTilePosition(2, i).getTile() != null) {
                                    if (tileTypes.contains(player.getShelves().getTilePosition(2, i).getTile().getType())) {
                                        ...
                                        if (player.getShelves().getTilePosition(3, i).getTile() != null) {
                                            if (tileTypes.contains(player.getShelves().getTilePosition(3, i).getTile().getType())) {
                                                ...
                                                if (player.getShelves().getTilePosition(4, i).getTile() != null) {
            ...
            case 5 -> {
                for(int i = 0; i < 5; i++) {
                    ...
                    if (player.getShelves().getTilePosition(i, 0).getTile() != null) {
                        ...
                        if (player.getShelves().getTilePosition(i, 1).getTile() != null) {
                            if (tileTypes.contains(player.getShelves().getTilePosition(i, 1).getTile().getType())) {
                                ...
                                if (player.getShelves().getTilePosition(i, 2).getTile() != null) {
                                    if (tileTypes.contains(player.getShelves().getTilePosition(i, 2).getTile().getType())) {
                                        ...
                                        if (player.getShelves().getTilePosition(i, 3).getTile() != null) {
                                            if (tileTypes.contains(player.getShelves().getTilePosition(i, 3).getTile().getType())) {
                                                ...
                                                if (player.getShelves().getTilePosition(i, 4).getTile() != null) {
                                                    if (tileTypes.contains(player.getShelves().getTilePosition(i, 4).getTile().getType())) {
                                                        ...
                                                        if (player.getShelves().getTilePosition(i, 5).getTile() != null) {
