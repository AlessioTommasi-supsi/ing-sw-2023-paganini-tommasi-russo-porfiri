            ...
            switch (arg.getChoice()) {
                ...
                case DRAW_FROM_BOARD:
                    ...
                    try {
                        ...
                        //model.getMyShelfie().getGame((Integer) arg.getArgument()).setState(GameStatus.LAST_TURN);
                    }
                ...
                case TERMINATE_TURNS:
                    ...
                    //Se la libreria del giocatore corrente è piena
                    if(model.getMyShelfie().getGame((Integer) arg.getArgument()).getCurrentPlayer().getShelves().isFull()) {
                ...
                case EXIT:
                    model.getMyShelfie().getGame((Integer) arg.getArgument()).fullLibrary();
                    model.getMyShelfie().getGame((Integer) arg.getArgument()).explicitEnd();
